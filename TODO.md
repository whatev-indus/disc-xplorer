...
- WBFS (Wii Backup File System) — full read + filesystem browse (GameCube and Wii encrypted partitions)
...
Added in v0.3.3:
- Wii ISO (.iso) — AES-128-CBC cluster decryption; FST browsing via WiiPartReader
